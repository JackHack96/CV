...
\section{Education}
\cventry{2010--2015}{High school diploma}{Angelo Messedaglia}{Verona}{}{}  % arguments 3 to 6 can be left empty
\cventry{2015--2018}{Bachelor Degree}{University of Verona}{Verona}{}{}
\cventry{2018--2020}{Master Degree}{University of Verona}{Verona}{}{}
...
\cventry{2020--2023}{Embedded software engineer}{EDALab S.r.L.}{San Giovanni Lupatoto}{}{General firmware and low-level embedded software development for third-parties.}
\subsection{Miscellaneous}
\cventry{2017--2018}{Generic worker}{University of Verona}{Verona}{}{I worked as a generic collaborator for the Department of Computer Science at University of Verona.}
\cventry{2017--2018}{Internship}{Sordato srl}{Monteforte d'Alpone}{}{Developed an automated management system for wine fermentation machines.}
\cventry{2018}{Generic worker}{University of Verona}{Verona}{}{I worked as an assistant at the G. Zanotto library of the Department of Law at University of Verona.}
\cventry{2019}{Internship}{University of Verona}{Verona}{}{Developed an operating system image for classrooms' displays based on Raspberry Pi.}
\cventry{2020}{Internship}{EDALab S.r.L.}{San Giovanni Lupatoto}{}{Integrated reliable update mechanism base on SWUpdate for BoxIO.}
\subsection{Volunteering}
\cventry{2017--\number\numexpr\year}{Technician}{AVIS}{Vigasio}{}{I volunteered as a technician and general assistance at the local AVIS association,
	an Italian organization that promotes blood donation.}

\section{Languages}
\cvitemwithcomment{Italian}{Native language}{}
\cvitemwithcomment{English}{Expert level}{}

%\section{Computer skills}
%\cvitem{Firmware Development}{Expertise in low-level programming for MCUs using C}
%\cvitem{Operating Systems}{Proficient in developing for Microsoft® Windows® and GNU/Linux}
%\cvitem{Office Automation}{Skilled in using Microsoft Office Suite and LibreOffice}
%\cvitem{Programming Languages}{Proficient in C, C++, Python}
%\cvitem{Web technologies}{HTML, CSS, Familiar with WordPress, Joomla}
%\cvitem{Scripting}{Bash, ZSH, Python}
%\cvitem{Embedded Systems}{Experienced using Yocto Project for customizing embedded Linux distributions}
...
\section{Interests}
\cvitem{Electronics}{I like to learn about electronics and tinkering with it, especially Arduino or similar technologies.}
\cvitem{DIY}{I love to repair home appliances and furnitures, aside from fixing broken computers and smartphones.}
\cvitem{Sports}{I love to workout and attending the gym.}
